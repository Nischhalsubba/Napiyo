...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/converter-contrast-hero-fix`](https://github.com/Nischhalsubba/Napiyo/tree/agent/converter-contrast-hero-fix). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/converter-contrast-hero-fix"]
