...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/custom-land-planner`](https://github.com/Nischhalsubba/Napiyo/tree/agent/custom-land-planner). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/custom-land-planner"]
