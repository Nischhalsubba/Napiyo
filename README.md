...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/gps-map-interaction-e2e`](https://github.com/Nischhalsubba/Napiyo/tree/agent/gps-map-interaction-e2e). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/gps-map-interaction-e2e"]
