...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/bright-viewport-shell`](https://github.com/Nischhalsubba/Napiyo/tree/agent/bright-viewport-shell). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/bright-viewport-shell"]
