...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/human-utility-redesign`](https://github.com/Nischhalsubba/Napiyo/tree/agent/human-utility-redesign). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/human-utility-redesign"]
