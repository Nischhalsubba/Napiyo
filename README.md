...
**Branch-aware technical guide for [`agent/frontend-rework-cloudflare`](https://github.com/Nischhalsubba/Napiyo/tree/agent/frontend-rework-cloudflare)**

<p><img alt="branch: agent/frontend-rework-cloudflare" src="https://img.shields.io/static/v1?label=&message=branch%3A%20agent%2Ffrontend-rework-cloudflare&color=5965F2&style=flat-square"> <img alt="React" src="https://img.shields.io/static/v1?label=&message=React&color=24292F&style=flat-square"> <img alt="Vite" src="https://img.shields.io/static/v1?label=&message=Vite&color=24292F&style=flat-square"> <img alt="Tailwind CSS" src="https://img.shields.io/static/v1?label=&message=Tailwind%20CSS&color=24292F&style=flat-square"> <img alt="TypeScript" src="https://img.shields.io/static/v1?label=&message=TypeScript&color=24292F&style=flat-square"> <img alt="HTML" src="https://img.shields.io/static/v1?label=&message=HTML&color=24292F&style=flat-square"> <img alt="CSS" src="https://img.shields.io/static/v1?label=&message=CSS&color=24292F&style=flat-square"> <img alt="docs: branch-aware" src="https://img.shields.io/static/v1?label=&message=docs%3A%20branch-aware&color=8250DF&style=flat-square"></p>

<p>
  <a href="https://github.com/Nischhalsubba/Napiyo/tree/agent/frontend-rework-cloudflare"><strong>Browse source</strong></a> ·
  <a href="https://github.com/Nischhalsubba/Napiyo/issues"><strong>Issues</strong></a> ·
  <a href="https://github.com/Nischhalsubba/Napiyo/codespaces/new?ref=agent%2Ffrontend-rework-cloudflare"><strong>Open in Codespaces</strong></a>
</p>

</div>

> [!IMPORTANT]
> This guide is generated from the files actually present on `agent/frontend-rework-cloudflare`. It links to detected source paths, preserves project-authored notes, and avoids claiming components that were not found.
...
| Stack | React, Vite, Tailwind CSS, TypeScript, HTML, CSS |
...
- [`README.md`](https://github.com/Nischhalsubba/Napiyo/blob/agent/frontend-rework-cloudflare/README.md)
- [`tsconfig.json`](https://github.com/Nischhalsubba/Napiyo/blob/agent/frontend-rework-cloudflare/tsconfig.json)
...
```mermaid
flowchart TD
    ROOT["Napiyo / agent/frontend-rework-cloudflare"]
    ROOT --> P0[".github/"]
    ROOT --> P1["components/"]
    ROOT --> P2["docs/"]
    ROOT --> P3["lib/"]
...
|---|---|
| Interface | [`public`](https://github.com/Nischhalsubba/Napiyo/tree/agent/frontend-rework-cloudflare/public), [`components`](https://github.com/Nischhalsubba/Napiyo/tree/agent/frontend-rework-cloudflare/components) |
| Application logic | [`lib`](https://github.com/Nischhalsubba/Napiyo/tree/agent/frontend-rework-cloudflare/lib) |
| Documentation | [`docs`](https://github.com/Nischhalsubba/Napiyo/tree/agent/frontend-rework-cloudflare/docs) |
| Delivery | [`.github`](https://github.com/Nischhalsubba/Napiyo/tree/agent/frontend-rework-cloudflare/.github) |
...
```mermaid
flowchart LR
    CHANGE["Change on agent/frontend-rework-cloudflare"] --> CHECK["Tests and quality checks"]
...
- [`.github/workflows/ci.yml`](https://github.com/Nischhalsubba/Napiyo/blob/agent/frontend-rework-cloudflare/.github/workflows/ci.yml)
...
| Branch | [`agent/frontend-rework-cloudflare`](https://github.com/Nischhalsubba/Napiyo/tree/agent/frontend-rework-cloudflare) |
