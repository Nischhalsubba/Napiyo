...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/frontend-rework-cloudflare`](https://github.com/Nischhalsubba/Napiyo/tree/agent/frontend-rework-cloudflare). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/frontend-rework-cloudflare"]
