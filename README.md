...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/full-bilingual-contrast`](https://github.com/Nischhalsubba/Napiyo/tree/agent/full-bilingual-contrast). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/full-bilingual-contrast"]
