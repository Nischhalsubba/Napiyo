...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/formula-realistic-ui`](https://github.com/Nischhalsubba/Napiyo/tree/agent/formula-realistic-ui). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/formula-realistic-ui"]
