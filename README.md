...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/speech-language-switch`](https://github.com/Nischhalsubba/Napiyo/tree/agent/speech-language-switch). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/speech-language-switch"]
