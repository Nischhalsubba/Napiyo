...
**Branch-aware technical guide for [`agent/dark-mode-contrast-fix`](https://github.com/Nischhalsubba/Napiyo/tree/agent/dark-mode-contrast-fix)**

<p><img alt="branch: agent/dark-mode-contrast-fix" src="https://img.shields.io/static/v1?label=&message=branch%3A%20agent%2Fdark-mode-contrast-fix&color=5965F2&style=flat-square"> <img alt="React" src="https://img.shields.io/static/v1?label=&message=React&color=24292F&style=flat-square"> <img alt="Vite" src="https://img.shields.io/static/v1?label=&message=Vite&color=24292F&style=flat-square"> <img alt="Tailwind CSS" src="https://img.shields.io/static/v1?label=&message=Tailwind%20CSS&color=24292F&style=flat-square"> <img alt="TypeScript" src="https://img.shields.io/static/v1?label=&message=TypeScript&color=24292F&style=flat-square"> <img alt="CSS" src="https://img.shields.io/static/v1?label=&message=CSS&color=24292F&style=flat-square"> <img alt="HTML" src="https://img.shields.io/static/v1?label=&message=HTML&color=24292F&style=flat-square"> <img alt="docs: branch-aware" src="https://img.shields.io/static/v1?label=&message=docs%3A%20branch-aware&color=8250DF&style=flat-square"></p>

<p>
  <a href="https://github.com/Nischhalsubba/Napiyo/tree/agent/dark-mode-contrast-fix"><strong>Browse source</strong></a> ·
  <a href="https://github.com/Nischhalsubba/Napiyo/issues"><strong>Issues</strong></a> ·
  <a href="https://github.com/Nischhalsubba/Napiyo/codespaces/new?ref=agent%2Fdark-mode-contrast-fix"><strong>Open in Codespaces</strong></a>
</p>

</div>

> [!IMPORTANT]
> This guide is generated from the files actually present on `agent/dark-mode-contrast-fix`. It links to detected source paths, preserves project-authored notes, and avoids claiming components that were not found.
...
- [`README.md`](https://github.com/Nischhalsubba/Napiyo/blob/agent/dark-mode-contrast-fix/README.md)
- [`index.css`](https://github.com/Nischhalsubba/Napiyo/blob/agent/dark-mode-contrast-fix/index.css)
...
|---|---|
| Interface | [`public`](https://github.com/Nischhalsubba/Napiyo/tree/agent/dark-mode-contrast-fix/public), [`components`](https://github.com/Nischhalsubba/Napiyo/tree/agent/dark-mode-contrast-fix/components) |
| Application logic | [`lib`](https://github.com/Nischhalsubba/Napiyo/tree/agent/dark-mode-contrast-fix/lib) |
| Quality | [`tests`](https://github.com/Nischhalsubba/Napiyo/tree/agent/dark-mode-contrast-fix/tests) |
| Documentation | [`docs`](https://github.com/Nischhalsubba/Napiyo/tree/agent/dark-mode-contrast-fix/docs) |
| Delivery | [`.github`](https://github.com/Nischhalsubba/Napiyo/tree/agent/dark-mode-contrast-fix/.github) |
...
- [`tests`](https://github.com/Nischhalsubba/Napiyo/tree/agent/dark-mode-contrast-fix/tests)
...
```mermaid
flowchart LR
    CHANGE["Change on agent/dark-mode-contrast-fix"] --> CHECK["Tests and quality checks"]
...
- [`.github/workflows/ci.yml`](https://github.com/Nischhalsubba/Napiyo/blob/agent/dark-mode-contrast-fix/.github/workflows/ci.yml)
- [`.github/workflows/cloudflare-build.yml`](https://github.com/Nischhalsubba/Napiyo/blob/agent/dark-mode-contrast-fix/.github/workflows/cloudflare-build.yml)
- [`.github/workflows/quality.yml`](https://github.com/Nischhalsubba/Napiyo/blob/agent/dark-mode-contrast-fix/.github/workflows/quality.yml)
