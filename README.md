...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/bilingual-e2e-followup`](https://github.com/Nischhalsubba/Napiyo/tree/agent/bilingual-e2e-followup). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/bilingual-e2e-followup"]
