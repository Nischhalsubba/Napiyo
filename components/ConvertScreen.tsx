  ...
  return (
    <div className="h-full w-full p-4 md:p-8 animate-enter overflow-y-auto">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-6 h-full md:h-auto">
        ...
        <div className="col-span-1 md:col-span-7 glass-panel rounded-3xl p-8 relative overflow-hidden flex flex-col justify-center min-h-[300px]">
          {/* Neon Glow blob */}
            ...
            <div className="flex flex-col md:flex-row gap-6 items-start md:items-center">
              ...
              <div className="relative shrink-0 w-full md:w-auto">
                <select
                  ...
                  className="w-full appearance-none bg-white/5 border border-white/10 text-white font-bold text-xl py-4 pl-6 pr-12 rounded-2xl cursor-pointer hover:bg-white/10 transition-colors focus:outline-none focus:border-neon-purple"
                >
          ...
          <div className="mt-8 flex flex-wrap gap-2 relative z-10">
            {QUICK_CHIPS.map((chip, idx) => (
              <button
                ...
                className="px-4 py-2 rounded-xl bg-white/5 border border-white/5 text-xs font-bold text-slate-400 hover:text-white hover:bg-white/10 hover:border-white/20 transition-all"
              >
                {chip.label}
              </button>
            ))}
        ...
        <div className="col-span-1 md:col-span-5 bg-gradient-to-br from-neon-purple to-indigo-600 rounded-3xl p-8 text-white relative flex flex-col justify-between shadow-2xl min-h-[300px] group">
          ...
          <button
            onClick={handleSave}
            className="mt-8 w-full py-4 bg-white text-neon-purple rounded-xl font-bold shadow-lg hover:shadow-xl hover:bg-slate-100 transition-all flex items-center justify-center gap-2"
          >
