...
const SavedScreen = ({ items, onDelete, onVisualize, onImport, notify }: Props) => {
  ...
  const trapComparisonFocus = (event: KeyboardEvent<HTMLElement>) => {
